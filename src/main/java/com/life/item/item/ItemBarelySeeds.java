...
public class ItemBarelySeeds extends Item implements IPlantable, IHasModel {

    public ItemBarelySeeds(String name)
    {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        {
            worldIn.setBlockState(pos.up(), BlockInit.barely_plant.getDefaultState());
    ...
    public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
        return BlockInit.barely_plant.getDefaultState();
    }
}
